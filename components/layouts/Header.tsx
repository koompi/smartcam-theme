...
export default function Header() {
  return (
    <nav className="hidden sm:hidden lg:flex justify-between w-full items-center gap-x-3 bg-gradient-to-r from-primary to-primary-800 px-3 sm:px-3 lg:px-6 py-1 text-foreground relative">
      <div className="flex flex-col sm:flex-col lg:flex-row items-start sm:items-start lg:items-center gap-0 sm:gap-0 lg:gap-3 text-xs">
        ...
        <Divider
          ...
          className="h-6 bg-foreground hidden sm:hidden lg:flex"
        />
