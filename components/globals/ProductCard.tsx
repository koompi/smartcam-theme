    ...
    >
      ...
      <CardBody className="flex flex-col flex-grow">
        ...
        <div className="flex flex-col flex-grow">
          ...
          <p className="text-gray-500 text-xs sm:text-xs lg:text-sm pl-1 whitespace-pre-line mt-2 sm:mt-2 lg:mt-3 fontSizeTextEditor line-clamp-3 sm:line-clamp-3 lg:line-clamp-none">
