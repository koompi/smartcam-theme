              ...
              <li key={stepIdx} className="relative">
                <div className="flex w-full max-w-full items-center">
                  <button
                    ...
                    className={cn(
                      "group flex w-full cursor-pointer items-center justify-center gap-3 rounded-large px-4 py-2.5",
                      stepClassName
                    )}
                      ...
                      <LazyMotion features={domAnimation}>
                        <div className="relative">
                          <m.div
                            animate={status}
                            className={cn(
                              "relative flex h-[1.5rem] w-[1.5rem] items-center justify-center rounded-full border-medium text-large font-semibold text-default-foreground",
                              {
                          ...
                          >
                            <div className="flex items-center justify-center">
                              {status === "complete" ? (
                                <CheckIcon className="h-3 w-3 text-[var(--active-fg-color)]" />
                              ) : (
                                <span>{stepIdx + 1}</span>
                              )}
                            </div>
